//package com.pkmmte.view; MIT License
package com.splashmobileproductions.scorekeep.view;
...
public class CircularImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        isTinted = attributes.getBoolean(R.styleable.CircularImageView_civ_tint, false);
        ...
        if (isTinted) {
            int tintColor = attributes.getColor(R.styleable.CircularImageView_civ_tintColor, Color.TRANSPARENT);
            if (tintColor == Color.TRANSPARENT) {
                tintFilter = null;
            } else {
                tintFilter = new LightingColorFilter(tintColor, 0);
            }
        }
    ...
    /**
     * Enables a tint for this CircularImageView.
     *
     * @param enabled Set to true to tint the image or false to draw original.
     */
    ...
    /**
     * Sets the CircularImageView's tint color.
     *
     * @param tintColor The new color (excluding alpha) to set the tint.
     */
    ...
    public void onDraw(@NonNull Canvas canvas) {
        ...
        if (hasSelector && isSelected) { // Draw the selector stroke & apply the selector filter, if applicable
            ...
            borderRect.set(outerWidth / 2, outerWidth / 2, canvasSize - outerWidth / 2, canvasSize - outerWidth / 2);
